...
import {  fetcher, fetcherSlug } from '../../../fetcher/securityFetcher'
type Props = {
    params : {
        slug : string
    }
...
async function page({params : {slug}} : Props) {
  ...
  return (
    <div>
        ...
        <section className='space-y-2 border border-[#04266f] text-white'>
            <div className = "relative min-h-56 flex flex-col md:flex-row justify-between">
                ...
                <section className='p-5 bg-[#04266f] w-full'>
